          ...
          <View style={styles.modalView}>
            <Pressable 
             ...
             <View style={{width:"100%",marginTop:20}}>
               <Card item={[
                 {id:1,firstIcon:<LocationIcon name="location" color ='gray' size={26}/>,description:'Booking Address',rightIcon:<MoreIcon name='arrow-forward-ios' size={15} color='#2f3e46'/>},
                 {id:2,firstIcon:<CreditcardIcon name='creditcard' color ='gray' size={26}/>,description:'Payment Method',rightIcon:<MoreIcon name='arrow-forward-ios' size={15} color='#2f3e46'/>},
                 {id:3,firstIcon:<WalletIcon name="wallet-outline" color="gray" size={26}/>,description:'Currency',rightIcon:<MoreIcon name='arrow-forward-ios' size={15} color='#2f3e46'/>,currency:'USD'},
                 {id:4,firstIcon:<LanguageIcon name="language" color="gray" size={26}/>,description:'Language',rightIcon:<MoreIcon name='arrow-forward-ios' size={18} color='#2f3e46'/>,language:'English'}
               ]}/>
             </View>
         <Pressable>
           <View style={{marginTop:50}}>
              <Text style={{
                color: "#B2002D",
                fontFamily: "Montserrat_500Medium",}}>LOG OUT</Text>
           </View>
          </Pressable>
          </View>
        </View>
